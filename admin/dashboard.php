  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-primary border-right text-white" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush bg-primary text-white">
        ...
        <a href="<?='dashboard.php?module=artikel&page=about';?>" class="list-group-item list-group-item-action bg-primary text-white"><i class="fas fa-address-card"></i> About</a>
        <a href="produk.php" class="list-group-item list-group-item-action bg-primary text-white"><i class="fas fa-layer-group"></i> Produk</a>
        <a href="layanan.php" class="list-group-item list-group-item-action bg-primary text-white"><i class="fas fa-wrench"></i> Layanan</a>
        <a href="kontak.php" class="list-group-item list-group-item-action bg-primary text-white"><i class="fas fa-id-card-alt"></i> Kontak</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
